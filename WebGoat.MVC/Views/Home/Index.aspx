...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        ...
        <div style="background-color: #558EDF; color: #FFFFFF; font-size: 180%; padding: 6px;
            padding-top: 8px; font-weight: bold; border: 3px solid #204A7F; border-right: none;
            border-left: none; margin: 0;">
            OWASP Top 10 Application Security Risks - 2010</div>
        <p>
            <br />
        </p>
        <table cellspacing="1" cellpadding="1" border="1" width="100%;">
            <tr>
                <td>
                    <center>
                        <a href="home/injection" title="Top 10 2010-A1" class="mw-redirect">A1-Injection</a></center>
                </td>
                <td>
                    ...
                    data can trick the interpreter into executing unintended commands or accessing unauthorized
                    data.
                </td>
            </tr>
            <tr>
                <td>
                    <center>
                        <a href="home/xss" title="Top 10 2010-A2" class="mw-redirect">A2-Cross Site Scripting
                            (XSS)</a></center>
                </td>
                <td>
                    XSS flaws occur whenever an application takes untrusted data and sends it to a web
                    browser without proper validation and escaping. XSS allows attackers to execute
            ...
            <tr>
                <td>
                    <center>
                        <a href="home/broken-auth" title="Top 10 2010-A3" class="mw-redirect">A3-Broken Authentication
                            and Session Management</a></center>
                </td>
                <td>
                    Application functions related to authentication and session management are often
                    not implemented correctly, allowing attackers to compromise passwords, keys, session
            ...
            <tr>
                <td>
                    <center>
                        <a href="home/insecure-reference" title="Top 10 2010-A4" class="mw-redirect">A4-Insecure
                            Direct Object References</a></center>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <center>
                        <a href="home/csrf" title="Top 10 2010-A5" class="mw-redirect">A5-Cross Site Request
                            Forgery (CSRF)</a></center>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    Many web applications check URL access rights before rendering protected links and
            ...
            <tr>
                <td>
                    <center>
                        <a title="Top 10 2010-A9" class="mw-redirect child-links" data="InsufficientTransportLayerProtection">A9-Insufficient
                            Transport Layer Protection</a></center>
                </td>
                <td>
                    Applications frequently fail to authenticate, encrypt, and protect the confidentiality
                    and integrity of sensitive network traffic. When they do, they sometimes support
                    weak algorithms, use expired or invalid certificates, or do not use them correctly.
            ...
            <tr>
                <td>
                    <center>
                        <a title="Top 10 2010-A10" class="mw-redirect child-links" data="UnvalidatedRedirectsAndForwards">A10-Unvalidated
                            Redirects and Forwards</a></center>
                </td>
                <td>
        ...
        <ul>
            <li><a href="/index.php/OWASP_Risk_Rating_Methodology" title="OWASP Risk Rating Methodology">
                OWASP Risk Rating Methodology</a> </li>
            <li><a href="/index.php/Threat_Risk_Modeling" title="Threat Risk Modeling">Article on
                Threat/Risk Modeling</a> </li>
        </ul>
        <p>
            <b>External</b>
        </p>
        <ul>
            <li><a href="http://fairwiki.riskmanagementinsight.com/" class="external text" rel="nofollow">
                FAIR Information Risk Framework</a> </li>
            <li><a href="http://msdn.microsoft.com/en-us/library/aa302419.aspx" class="external text"
                rel="nofollow">Microsoft Threat Modeling (STRIDE and DREAD)</a> </li>
        </ul>
        <p>
            <br />
        </p>
